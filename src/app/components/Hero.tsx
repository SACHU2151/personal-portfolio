    ...
    <section className="py-28">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.a
              href="https://github.com/SACHU2151"
              target="_blank"
            ...
            <motion.a
              href="https://www.linkedin.com/in/sachin-shivade-8b7868253/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary transition-colors"
              whileHover={{ scale: 1.2 }}
          ...
          >
            ...
            >
              <a
                className="bg-primary inline-flex items-center gap-2 w-full md:w-auto text-white px-8 py-3 rounded-lg hover:bg-primary/90 transition-colors group"
                href="/Sachin-Shivade-CV.pdf"
                download
              >
